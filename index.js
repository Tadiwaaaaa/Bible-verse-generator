...
function generateVerse(event) {
  ...
  let context = "You are a Christian growing their knowledge and relationship with God. Your goal is to memorize as many bible verses as possible. Make sure to follow the user instruction to generate the correct bible verse in basic HTML. Encapsulate the whole verse in the <i></i> element";
  let apiUrl =
